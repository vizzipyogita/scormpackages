            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">{{ env('APPLICATION_NAME') }}</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="forgotpasswordpost" method="POST">
              @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button id="submitBtn" class="btn btn-primary d-grid w-100" type="submit">Submit</button>
                </div>
              </form>
