...
<div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<form role="form" action="{{ route('userPaymentPost') }}" method="post" class="mb-3 require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
			@csrf
			...
			<div class="row mt-3">
				<div class="form-group justify-content-center text-center">
					<h3>{!! Session::get('currency') !!}{{$planAmount}} for year</h3>
				</div>
				...
				<div class="form-group formPayment">
					<div class="credit-card-box" id="creditCardBox">
						...
						<div class="form-group mt-3 justify-content-center text-center">
							<button type="submit" class="btn learn-btn" id="subscription_pay_btn">Pay</button>
							<a class="btn btn-secondary btn-cancel align-items-center justify-content-center" href="/organization/upgrade">Cancel</a>
						</div>
						<div class="mt-4 margin_zero margin_bottom_twenty justify-content-center text-center padding_left_ten">
